...
function register(req, res) {
  ...
  var mailOptions = {
    ...
    text:
      'Confirm Email: https://mywatchlist.000webhostapp.com/confirmemail' +
...
function rememberAuth(req, res) {
  ...
  var newPass = Math.floor(Math.random() * 10000) + 'list';
